export const personalData = {
  ...
  education: [
    ...
    "National Diploma in Banking And Finance  (2015-2017)",
  ],
  contactLinks: [
    "mailto:emailto:goodyc474@gmail.com",
    "https://twitter.com/goodylove474",
    "https://linkedin.com/nwachukwu goodness",
    "https://github.com/goodylove",
  ],
};
...
export const professionalData = {
  ...
  experiences: [
    ...
    {
      role: "Built Birthday Reminder App ",
      description:
